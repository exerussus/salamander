...
и свойствах сущностей — везде показывается тот `doc`/`summary`, который задал
хост.
...
свойства сущностей и константы API — с тем самым `doc`/`summary`, который задал
хост. Константы API при этом и красятся отдельно от свойств: у них нет
...
- **Хост-API**: fluent (`Class/Prop/Fn/Act/Event/Enum/Struct/Archetype`) и атрибуты
  ...
  ни делегата в реестре, ни хостового вызова в байткоде;
